        ...
        <div id='home-wrapper'>
            ...
            <div id='home-info'>
                <div className='home-info-box'>
                    <div className='home-info-icon'><img width='50%' src='https://i.imgur.com/7H2M39A.png'/></div>
                    <h3>Visual</h3>
                    <p> Lorem ipsum etc.</p>
                </div>
                <div className='home-info-box'>
                    <div className='home-info-icon'><img width='50%' src='https://i.imgur.com/zAAVWb0.png'/></div>
                    <h3>Lightweight</h3>
                    <p>Can I offer you a nice egg in this trying time?</p>
                </div>
                <div className='home-info-box'>
                    <div className='home-info-icon'><img width='50%' src='https://i.imgur.com/YOFpmB9.png'/></div>
                    <h3>Real-time</h3>
